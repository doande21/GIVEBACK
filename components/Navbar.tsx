    ...
    <nav className="fixed top-0 left-0 right-0 z-[100] bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-b border-emerald-50 dark:border-emerald-900/30 h-16 flex items-center px-4 transition-colors duration-500 shadow-sm">
      <div className="max-w-7xl mx-auto w-full flex items-center justify-between">
        ...
        >
          ...
          <span className="text-xl font-black text-emerald-950 dark:text-emerald-400 tracking-tighter uppercase italic">GIVEBACK</span>
        </div>
        ...
        <div className="flex items-center space-x-1 md:space-x-2">
          ...
          <button onClick={() => { if (window.confirm("Đệ muốn đăng xuất?")) onLogout(); }} className="p-2 text-gray-400 hover:text-red-500 transition-colors ml-1 hidden md:block" title="Đăng xuất"><svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" /></svg></button>
        </div>
      </div>
    </nav>
  );
