        ...
        <div className="max-w-7xl mx-auto w-full flex items-center justify-between">
          ...
          <div className="flex items-center space-x-1 md:space-x-2">
            ...
            <button 
              ...
              className={`p-2.5 rounded-2xl transition-all ${activeTab === 'showcase' ? 'bg-amber-100 dark:bg-amber-900/30 text-amber-600' : 'bg-amber-50 dark:bg-amber-900/10 text-amber-500 hover:bg-amber-500 hover:text-white'}`}
            ...
            }} className="p-2 text-gray-400 hover:text-red-500 transition-colors ml-1 hidden md:block" title="Đăng xuất">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
